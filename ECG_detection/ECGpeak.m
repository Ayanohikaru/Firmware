...
function [ECG_pks,ECG_loc] = ECGpeak(m_t0,m_II,m_fs,s,delta)
...
%% In case no data extracted
ECG_pks(isnan(ECG_pks)) = [];
ECG_loc(isnan(ECG_loc)) = [];
%% 
...
% figure('name','ECG II PEAKs');
% plot(t,ecg,t(ECG_loc),ECG_pks,'ro');
end